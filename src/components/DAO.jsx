        ...
        <div className="dao-left-section">
          ...
          <div className="proposals-card">
            ...
            <div className="proposal-loading">
              ...
              <span>Loading active governance proposals...</span>
            </div>
          </div>
        </div>
        ...
        <div className="dao-side-cards">
          ...
          <div className="idl-power-card">
            <div className="power-info">
              ...
              <span className="power-subtext">Power activates after self-delegation</span>
              <div className="dao-points">
                Dao Points <span className="points-val">0</span>
              </div>
            </div>
            <button className="btn-add-power">
              <Plus size={20} />
            </button>
          </div>
